    ...
    <div className='grid gap-8 py-20'>
      <div className='flex flex-col items-center space-y-8 text-center'>
        <div className='space-y-2' data-aos='fade-up' data-aos-delay={100}>
          ...
          <h1 className='text-5xl font-bold tracking-tighter'>This Feature is Coming Soon</h1>
          <p className='text-sm text-muted-foreground'>
            We're working hard to bring you the best laundry experience. Stay tuned for our launch!
          </p>
        </div>
        ...
        <div className='w-full max-w-sm space-y-2' data-aos='fade-up' data-aos-delay={300}>
