...
export default class OutletsRouter {
  ...
  private initializeRoutes(): void {
    ...
    // this.router.get('/:outlet_id/employees/:employee_id', this.outletEmployeeController.show);
    // this.router.put('/:outlet_id/employees/:employee_id', this.outletEmployeeController.update);
    // this.router.delete('/:outlet_id/employees/:employee_id', this.outletEmployeeController.destroy);
  }
